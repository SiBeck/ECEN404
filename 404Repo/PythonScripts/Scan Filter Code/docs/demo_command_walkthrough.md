...
**What happens**
- Prints the curated case table to the terminal without touching disk.
- Columns cover beat count, RR interval, modality, noise levels, frame spacing, jitter, offsets, and random seeds.
...
- Console table only—treat it as a glossary. Call out what each column means using the terminology list above.
